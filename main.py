...
class mainframe(Frame):
	...
	#Create table for students
		...
		if result:
			...
			mycursor.execute("CREATE TABLE temp_table(student_id CHAR(10) NOT NULL, time_in DATETIME(6) , time_out DATETIME(6))")
		mysqldb.close()
		...
		if result:
			...
			# there are no tables named "tableName"
			mycursor.execute("CREATE TABLE event_info(event_id VARCHAR(100) NOT NULL, event_name VARCHAR(100) NOT NULL , location VARCHAR(100) , date_started DATETIME(6) , date_ended DATETIME(6), PRIMARY KEY (event_id) )")
		mysqldb.close()
