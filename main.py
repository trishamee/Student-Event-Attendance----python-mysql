...
#        self.search_bar.grid(row = 0, column = 1, sticky = 'w',columnspan = 2) 
	#Labels and title
#        self.disp_label = Label(self.btn_frame, text = 'Search:', font= 'Segoe 16', bg = 'slategray2', fg = 'black').grid(row = 0, column = 0,padx = 1, pady =5, sticky ='e')
#        self.title_label = Label(master, text = 'Student Information System', font = 'Segoe 35', bg = 'slategray2', fg = 'Gold').grid(row = 0, column = 0,sticky = 'ew', padx = 7, pady = 25, columnspan = 12)
